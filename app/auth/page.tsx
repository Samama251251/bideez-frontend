  ...
  return (
    <div className="relative grid min-h-svh lg:grid-cols-[1.05fr_1fr]">
      ...
      <div aria-hidden className="pointer-events-none fixed inset-0 -z-10">
        ...
        />
        <div
          className="absolute bottom-[-12%] right-[8%] size-[40rem] rounded-full opacity-50 blur-3xl"
          style={{
            background:
      ...
      <aside className="grain relative hidden flex-col justify-between overflow-hidden border-r border-border px-12 py-12 lg:flex">
        <div
          aria-hidden
          className="pointer-events-none absolute inset-0 -z-10 opacity-[0.35] [mask-image:radial-gradient(80%_60%_at_30%_20%,black,transparent)]"
          style={{
            backgroundImage:
